...
for(const f of ['005_catalog_edit','006_reset_selections','007_chat','008_signup_device','009_login_wait'])await db.exec(readFileSync(`supabase/migrations/${f}.sql`,'utf8'));
