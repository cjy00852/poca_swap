...
for(const f of ['005_catalog_edit','006_reset_selections','007_chat','008_signup_device','009_login_wait','010_remove_login_cooldown','011_next_features','012_admin_participants','013_session_management'])await db.exec(readFileSync(`supabase/migrations/${f}.sql`,'utf8'));
